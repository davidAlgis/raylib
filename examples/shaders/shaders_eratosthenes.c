...
int main(void)
{
    ...
    while (!WindowShouldClose())        // Detect window close button or ESC key
    {
        ...
        BeginTextureMode(target);       // Enable drawing to texture
            ...
            // NOTE: RectangleRaylib uses font white character texture coordinates,
        ...
        BeginDrawing();
            ...
            BeginShaderMode(shader);
                ...
                DrawTextureRec(target.texture, (RectangleRaylib){ 0, 0, (float)target.texture.width, (float)-target.texture.height }, (Vector2){ 0.0f, 0.0f }, WHITE);
            EndShaderMode();
        EndDrawing();
        //----------------------------------------------------------------------------------
    }
