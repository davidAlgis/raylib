...
int main(void)
{
    ...
    // Box A: Moving box
    RectangleRaylib boxA = { 10, GetScreenHeight()/2.0f - 50, 200, 100 };
    int boxASpeedX = 4;

    // Box B: Mouse moved box
    RectangleRaylib boxB = { GetScreenWidth()/2.0f - 30, GetScreenHeight()/2.0f - 30, 60, 60 };

    RectangleRaylib boxCollision = { 0 }; // Collision rectangle
