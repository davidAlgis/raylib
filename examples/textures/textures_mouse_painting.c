...
int main(void)
{
    ...
    RectangleRaylib colorsRecs[MAX_COLORS_COUNT] = { 0 };
    ...
    RectangleRaylib btnSaveRec = { 750, 10, 40, 30 };
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        DrawRectangleLinesEx((RectangleRaylib){ colorsRecs[colorSelected].x - 2, colorsRecs[colorSelected].y - 2,
