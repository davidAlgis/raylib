...
void DrawBillboardRec(Camera camera, Texture2D texture, RectangleRaylib source, Vector3 position, Vector2 size, Color tint)
{
...
void DrawBillboardPro(Camera camera, Texture2D texture, RectangleRaylib source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, Color tint)
{
