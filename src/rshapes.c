...
RectangleRaylib texShapesRec = { 0.0f, 0.0f, 1.0f, 1.0f };    // Texture source rectangle used on shapes drawing
...
void SetShapesTexture(Texture2D texture, RectangleRaylib source)
{
    ...
    if ((texture.id == 0) || (source.width == 0) || (source.height == 0))
    {
        ...
        texShapesRec = (RectangleRaylib){ 0.0f, 0.0f, 1.0f, 1.0f };
    }
    else
    {
        texShapes = texture;
...
{
    DrawRectanglePro((RectangleRaylib){ position.x, position.y, size.x, size.y }, (Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle
void DrawRectangleRec(RectangleRaylib rec, Color color)
{
    DrawRectanglePro(rec, (Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle with pro parameters
void DrawRectanglePro(RectangleRaylib rec, Vector2 origin, float rotation, Color color)
{
    Vector2 topLeft = { 0 };
    Vector2 topRight = { 0 };
...
{
    DrawRectangleGradientEx((RectangleRaylib){ (float)posX, (float)posY, (float)width, (float)height }, color1, color2, color2, color1);
}
...
{
    DrawRectangleGradientEx((RectangleRaylib){ (float)posX, (float)posY, (float)width, (float)height }, color1, color1, color2, color2);
}

// Draw a gradient-filled rectangle
// NOTE: Colors refer to corners, starting at top-lef corner and counter-clockwise
void DrawRectangleGradientEx(RectangleRaylib rec, Color col1, Color col2, Color col3, Color col4)
{
    rlSetTexture(texShapes.id);
...
void DrawRectangleLinesEx(RectangleRaylib rec, float lineThick, Color color)
{
    ...
    RectangleRaylib top = { rec.x, rec.y, rec.width, lineThick };
    RectangleRaylib bottom = { rec.x, rec.y - lineThick + rec.height, rec.width, lineThick };
    RectangleRaylib left = { rec.x, rec.y + lineThick, lineThick, rec.height - lineThick*2.0f };
    RectangleRaylib right = { rec.x - lineThick + rec.width, rec.y + lineThick, lineThick, rec.height - lineThick*2.0f };
...
void DrawRectangleRounded(RectangleRaylib rec, float roundness, int segments, Color color)
{
...
void DrawRectangleRoundedLines(RectangleRaylib rec, float roundness, int segments, float lineThick, Color color)
{
    ...
    if (roundness <= 0.0f)
    {
        DrawRectangleLinesEx((RectangleRaylib){rec.x-lineThick, rec.y-lineThick, rec.width+2*lineThick, rec.height+2*lineThick}, lineThick, color);
        return;
    }
...
bool CheckCollisionPointRec(Vector2 point, RectangleRaylib rec)
{
...
bool CheckCollisionRecs(RectangleRaylib rec1, RectangleRaylib rec2)
{
    bool collision = false;
...
bool CheckCollisionCircleRec(Vector2 center, float radius, RectangleRaylib rec)
{
    bool collision = false;
...
RectangleRaylib GetCollisionRec(RectangleRaylib rec1, RectangleRaylib rec2)
{
    RectangleRaylib overlap = { 0 };
